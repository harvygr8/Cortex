...
export class ResponseNode {
  constructor() {
    ...
    const prompt = ChatPromptTemplate.fromTemplate(`
      You are 'Cortex' - an AI agent based on Llama 3.2 and you are a precise and helpful AI assistant. Your task is to answer questions based on the provided context sections.
...
export class KnowledgeNode {
  constructor() {
    ...
    const prompt = ChatPromptTemplate.fromTemplate(`
      You are 'Cortex' - an AI agent based on Llama 3.2 and you are a knowledgeable AI assistant. Your task is to answer questions using your training data and general knowledge.
      Do not reference any context sections - just answer based on what you know.
  ...
  async invoke(input) {
    try {
      ...
      console.error('[KnowledgeNode] Error:', error);
      return {
        content: "I'm sorry, I encountered an error processing your request.",
        sources: []
      };
