...
class ProjectStore {
  ...
  // Scratchpads methods
  async addScratchpad(projectId, text = '', positionX = 0, positionY = 0, sourceHandle = null, targetHandle = null) {
    await this.initialize();
    const id = Date.now().toString();
  ...
  async getScratchpadsByProject(projectId) {
    await this.initialize();
  ...
  async updateScratchpadText(id, text) {
    await this.initialize();
    await this.db.run(
  ...
  async updateScratchpadPosition(id, positionX, positionY) {
    await this.initialize();
    await this.db.run(
  ...
  async updateScratchpadHandles(id, sourceHandle, targetHandle) {
    await this.initialize();
    await this.db.run(
  ...
  async updateScratchpadProject(id, projectId) {
    await this.initialize();
    await this.db.run(
  ...
  async deleteScratchpad(id) {
    await this.initialize();
    await this.db.run('DELETE FROM scratchpads WHERE id = ?', id);
  }

  // Images methods
  async addImage(projectId, imageUrl = '', imageAlt = '', positionX = 0, positionY = 0, sourceHandle = null, targetHandle = null) {
    await this.initialize();
    const id = Date.now().toString();
  ...
  async updateImageData(id, imageUrl, imageAlt) {
    await this.initialize();
    await this.db.run(
  ...
  async updateImagePosition(id, positionX, positionY) {
    await this.initialize();
    await this.db.run(
  ...
  async updateImageHandles(id, sourceHandle, targetHandle) {
    await this.initialize();
    await this.db.run(
  ...
  async updateImageProject(id, projectId) {
    await this.initialize();
    await this.db.run(
  ...
  // Container methods
  async addContainer(projectId, label = 'Container', color = '#3b82f6', positionX = 0, positionY = 0, width = 300, height = 200, zIndex = 0) {
    await this.initialize();
    const id = Date.now().toString();
  ...
  async updateContainerLabel(id, label) {
    await this.initialize();
    await this.db.run(
  ...
  async updateContainerColor(id, color) {
    await this.initialize();
    await this.db.run(
  ...
  async updateContainerPosition(id, positionX, positionY) {
    await this.initialize();
    await this.db.run(
  ...
  async updateContainerSize(id, width, height) {
    await this.initialize();
    await this.db.run(
  ...
  async updateContainerZIndex(id, zIndex) {
    await this.initialize();
    await this.db.run(
